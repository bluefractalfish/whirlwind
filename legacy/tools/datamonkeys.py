...
"""whirlwind.tools.datamonkeys 

    PURPOSE:
         serializing and filesystem helpers 
    PUBLIC:
        get_byte_size(uri) -> str 
        affine_to_list, list_to_affine 
        npy_bytes, json_bytes 
        created_at, utc_now 
        dir_bytes, count_byes 
