...
class ShardWriter:
    ...
    def _open_next(self) -> None:
        ...
        self.shard_index += 1
    def _write_sample(self, key: str, npy: bytes, meta_json: bytes) -> Tuple[str,str]:
        """
...
def _iter_uris(input_dir: Optional[str],input_csv: Optional[str], extensions: List[str]=(".tif",".tiff")) -> Iterator[str]:
    """
